...
import { Upload, Zap, Eye, X, Check, AlertCircle, ArrowRight } from "lucide-react";
...
export default function GeneratePage() {
  ...
  return (
    <motion.div
      ...
      className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6 max-w-7xl mx-auto min-h-screen"
    >
      {/* Left Panel: Input */}
                ...
                {slides.map((_, i) => (
                  <motion.button
                    ...
                    className={`w-2 h-2 rounded-full transition ${
                      i === currentSlideIndex ? "bg-primary w-6" : "bg-muted"
                    }`}
